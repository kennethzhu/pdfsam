...
public class DialogUtility {
	 ...
	 */
	public static int showConfirmOuputLocationDialog(Component comp,
			String suggestedDir) {

		return JOptionPane.showOptionDialog(
				comp,
				GettextResource.gettext(Configuration.getInstance()
						...
						+ " "
						+ suggestedDir + " ?", GettextResource.gettext(
	...
	public static void showRunSuccessDialog(Component comp, String suggestedDir) {

		 JOptionPane.showMessageDialog(
				comp,
				GettextResource.gettext(Configuration.getInstance()
						.getI18nResourceBundle(),
						suggestedDir), "¹§Ï²", JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public static void showWarningNoDocsSelected(Component comp, int msgType) {
		String msg = GettextResource.gettext(Configuration.getInstance()
				.getI18nResourceBundle(),
				"Please select at least one pdf document.");
		if (TWO_DOC == msgType) {
			msg = GettextResource.gettext(Configuration.getInstance()
					.getI18nResourceBundle(),
					"Please select two pdf documents.");
		} else if (ONE_DOC == msgType) {
			msg = GettextResource.gettext(Configuration.getInstance()
					.getI18nResourceBundle(), "Please select a pdf document.");
		}
		JOptionPane.showMessageDialog(comp, msg,
				GettextResource.gettext(Configuration.getInstance()
						.getI18nResourceBundle(), "Warning"),
	...
	public static void showWarningAddingDocument(Component comp) {
		JOptionPane.showMessageDialog(comp, GettextResource.gettext(
				Configuration.getInstance().getI18nResourceBundle(),
				"Please wait while all files are processed."), GettextResource
				.gettext(Configuration.getInstance().getI18nResourceBundle(),
						"Still adding files"), JOptionPane.WARNING_MESSAGE);
	}
	 ...
	 * @param msgType
	 */
	public static void showWarningNoDestinationSelected(Component comp,
			int msgType) {
		String msg;
		...
		JOptionPane.showMessageDialog(comp, msg, GettextResource.gettext(
				Configuration.getInstance().getI18nResourceBundle(),
				"No destination selected"), JOptionPane.WARNING_MESSAGE);
	}
	 ...
	 * @return an integer indicating the option chosen by the user
	 */
	public static int askForOverwriteOutputFileDialog(Component comp,
			String filename) {
		...
		return JOptionPane.showOptionDialog(
				...
				GettextResource.gettext(Configuration.getInstance()
						.getI18nResourceBundle(), "Output location error"),
				JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,
				null, null, null);
	}
		...
		return JOptionPane
				.showOptionDialog(
						...
						GettextResource
								...
								+ "\n"
								+ GettextResource.gettext(Configuration
										.getInstance().getI18nResourceBundle(),
										"Do you confirm to overwrite?"),
						GettextResource.gettext(Configuration.getInstance()
								.getI18nResourceBundle(), "Confirm overwrite"),
	 ...
	 * @param message
	 */
	public static void errorGenericDialog(Component comp, String title,
			String message) {
	...
	public static int askForEmptySelectionPanel(Component comp) {
		return JOptionPane
				.showConfirmDialog(
						...
						GettextResource.gettext(Configuration.getInstance()
								.getI18nResourceBundle(), "List full"),
	 ...
	 * @return
	 */
	public static int askForPdfVersionConfilct(Component comp,
