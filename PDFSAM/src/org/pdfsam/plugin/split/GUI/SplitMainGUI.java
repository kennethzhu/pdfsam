...
//    private JHelpLabel destinationHelpLabel;
    ...
    private final String PLUGIN_AUTHOR = "HiTex";
    private final String PLUGIN_VERSION = "0.1";
...
//    	String s=DialogUtility.askForDocumentPasswordDialog(this,"«Î ‰»Î√‹¬Î£∫");
////    	System.out.println("mmmmmm="+s);
//    	   	while(s==null||!s.equals("1234")){
//    		s=DialogUtility.askForDocumentPasswordDialog(this,"√‹¬Î≤ª’˝»∑£¨«Î ‰»Î√‹¬Î£∫");
//    	}
        ...
        burstRadio.setText(GettextResource.gettext(config.getI18nResourceBundle(), "ANDRE"));
        burstRadio.setSelected(true);
        this.setSplitType(burstRadio.getSplitCommand());
        ...
        thisPageRadio.setText(GettextResource.gettext(config.getI18nResourceBundle(), "Tally WEIJL"));
...
//        outputPanelLayout.putConstraint(SpringLayout.EAST, prefixHelpLabel, -1, SpringLayout.EAST, outputOptionsPanel);
        ...
        splitSpringLayout.putConstraint(SpringLayout.NORTH, runButton, 10, SpringLayout.SOUTH, splitOptionsPanel);
...
//        optionsPaneLayout.putConstraint(SpringLayout.EAST, checksHelpLabel, -1, SpringLayout.EAST, splitOptionsPanel);
    ...
    /**
     * 
     * @author HiTex  Focus policy for split panel
     * 
     */
